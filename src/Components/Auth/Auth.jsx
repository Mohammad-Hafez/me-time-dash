    ...
    return (
        <>
            ...
            <div className="flex flex-col md:flex-row min-h-screen overflow-x-hidden">
                <div
                    className={`min-h-screen flex items-center justify-center w-full md:w-1/2
                ...
                >
                    {registerSteps ? (
                        <CompleteRegistration t={t} />
                    ) : isLogin ? (
                        <LoginForm handleToggle={handleToggle} t={t} />
                    ) : (
                        <RegisterForm setRegisterSteps={setRegisterSteps} handleToggle={handleToggle} t={t} />
                    )}
                </div>
                <div
                    className={`w-full md:w-1/2 relative bg-pink-50 h-screen shadow-md
